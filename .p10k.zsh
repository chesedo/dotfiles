# Generated by Powerlevel10k configuration wizard on 2021-07-30 at 11:17 SAST.
...
() {
  ...
  typeset -g POWERLEVEL9K_TERRAFORM_DEV_CONTENT_EXPANSION='> ${P9K_CONTENT} <'
  typeset -g POWERLEVEL9K_TERRAFORM_PROD_CONTENT_EXPANSION='> ${P9K_CONTENT} <'
  typeset -g POWERLEVEL9K_TERRAFORM_CLASSES=(
      'default'   PROD
      'dev'       DEV
      '*'         OTHER)
